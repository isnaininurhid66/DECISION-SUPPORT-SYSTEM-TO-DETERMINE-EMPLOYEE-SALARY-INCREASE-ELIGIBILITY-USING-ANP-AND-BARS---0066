...
<div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Data SubKriteria ANP dan BARS</h4>
                                <a class="btn btn-primary" href="?page=subkriteria/subkriteria_tambah"><span class="glyphicon glyphicon-plus"></span> Tambah</a>
                            </div>
  <div class="card-body">
