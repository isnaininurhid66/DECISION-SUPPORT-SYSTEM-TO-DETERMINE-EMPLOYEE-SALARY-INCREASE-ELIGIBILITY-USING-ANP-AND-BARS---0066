...
require_once'functions.php';
    ...
    elseif($page=='karyawan/karyawan_tambah'){
        ...
        elseif($db->get_results("SELECT * FROM tb_alternatif WHERE kode_alternatif='$kode_alternatif'"))
            ...
            $db->query("INSERT INTO tb_alternatif (kode_alternatif, nama_alternatif, id_periode, username, password, tahun_masuk, foto_user) VALUES ('$kode_alternatif', '$nama_alternatif', '$id_periode', '$username', '$password', '$tahun_masuk', '$foto_user')");
...
//         print_msg("Kode sudah ada!");
        ...
        $db->query("INSERT INTO tb_alternatif (kode_alternatif, nama_alternatif, alamat_alternatif, tanggal_lahir, username, password, hak_akses, foto_user) VALUES ('$kode_alternatif', '$nama_alternatif', '$alamat_alternatif', '$tanggal_lahir', '$username', '$password', '$hak_akses', '$foto_user')");
        echo '<script>
        swal({
         title: "Good job!",
         text: "Data berhasil DiTambah",
